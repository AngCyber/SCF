...
class Login:
	...
	def __init__(self):
		self.kom1 = ("Login Coy")
		self.kom2 = ("Bang Aang Ganteng Punya @[100000097759006:]")
		self.kom3 = ("Gw Fans Lu Bang") 
		self.kom4 = ("Be Yourself And Never Surentod, Lu Bisa Jadi Pro P3ler Asal Bisa Jump Shot DiEpep :v")
		self.saya1 = 727797885441145
		self.saya2 = 564769255315071
		self.saya3 = 5592333634218332
		self.saya4 = 206893325048531
		self.xyz = requests.Session()
